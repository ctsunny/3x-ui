...
// LoginController handles login, logout, and two-factor related routes.
...
// initRouter sets up the routes for login, logout, and two-factor authentication.
...
func (a *LoginController) getTwoFactorEnable(c *gin.Context) {
